...
export default class FrontOfficeApi {
    ...
    */
     ...
     * @param {module:model/StatelessPersonalizedDocumentsRequest} statelessPersonalizedDocumentsRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/StatelessPersonalizedDocumentsResponse} and HTTP response
     */
    getStatelessPersonalizedDocumentsWithHttpInfo(statelessPersonalizedDocumentsRequest) {
      let postBody = statelessPersonalizedDocumentsRequest;
      // verify the required parameter 'statelessPersonalizedDocumentsRequest' is set
      if (statelessPersonalizedDocumentsRequest === undefined || statelessPersonalizedDocumentsRequest === null) {
        throw new Error("Missing the required parameter 'statelessPersonalizedDocumentsRequest' when calling getStatelessPersonalizedDocuments");
      }
      ...
      let accepts = ['application/json'];
      let returnType = StatelessPersonalizedDocumentsResponse;
      return this.apiClient.callApi(
        '/personalized_documents', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * Returns a list of personalized documents based on interests derived from a history. In difference to `getPersonalizedDocuments` any user specific parts are based on the inputs only. Documents still need to be ingested beforehand.
     * @param {module:model/StatelessPersonalizedDocumentsRequest} statelessPersonalizedDocumentsRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/StatelessPersonalizedDocumentsResponse}
     */
    getStatelessPersonalizedDocuments(statelessPersonalizedDocumentsRequest) {
      return this.getStatelessPersonalizedDocumentsWithHttpInfo(statelessPersonalizedDocumentsRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
